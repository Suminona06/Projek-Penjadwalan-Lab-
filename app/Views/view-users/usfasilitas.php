        ...
        <?php foreach ($ruangan as $idRuangan => $fasilitas): ?>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="heading<?= $idRuangan ?>">
              <button class="accordion-button collapsed-down" type="button" data-bs-toggle="collapse"
                data-bs-target="#collapse<?= $idRuangan ?>" aria-expanded="false"
                aria-controls="collapse<?= $idRuangan ?>">
                Software
                <?= $namaRuangan ?> <!-- Menggunakan nama ruangan di sini -->
              </button>
            </h2>
            <div id="collapse<?= $idRuangan ?>" class="accordion-collapse collapse"
              aria-labelledby="heading<?= $idRuangan ?>" data-bs-parent="#accordionExample">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="heading<?= $idRuangan ?>">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                data-bs-target="#flush-collapseOne<?= $idRuangan ?>" aria-expanded="false"
                aria-controls="flush-collapseOne<?= $idRuangan ?>">
                Hardware
                <?= $namaRuangan ?> <!-- Menggunakan nama ruangan di sini -->
              </button>
            </h2>
            <div id="flush-collapseOne<?= $idRuangan ?>" class="accordion-collapse collapse"
              aria-labelledby="heading<?= $idRuangan ?>" data-bs-parent="#accordionFlushExample">
              <div class="accordion-body">
                <div class="row">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="heading<?= $idRuangan ?>">
              <button class="accordion-button" type="button" data-bs-toggle="collapse"
                data-bs-target="#panelsStayOpen-collapseOne<?= $idRuangan ?>" aria-expanded="false"
                aria-controls="panelsStayOpen-collapseOne<?= $idRuangan ?>">
                Barang
                <?= $namaRuangan ?> <!-- Menggunakan nama ruangan di sini -->
              </button>
            </h2>
            <div id="panelsStayOpen-collapseOne<?= $idRuangan ?>" class="accordion-collapse collapse"
              aria-labelledby="heading<?= $idRuangan ?>" data-bs-parent="#accordionPanelsStayOpenExample">
              <div class="accordion-body">
                <div class="row">
