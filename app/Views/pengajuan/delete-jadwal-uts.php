...
<table class="table table-bordered my-3">
    ...
    <a href="<?= route_to('user.jadwal.uts', $idProdi); ?>" class="btn btn-primary mt-4 mx-3">Tambah Jadwal</a>
    <a href="<?= route_to('uts.export.pdf', $idProdi); ?>" class="btn btn-warning mt-4">Export Pdf</a>
</table>
